...
\chapter{Lit review}
    ...
    \section{Data integrity}
        ...
        % TODO: add a seciton SSD reliability and move the bit from design here (need lots of changes there tho)
            SSDs and flash storage in general are a similar story. As
            \citeauthor{2D_RAID} puts it: "Flash is basically garbage. It
            barely works. We tolerate it because it is fast". They employ
