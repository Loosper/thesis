...
\chapter{Lit review}
    ...
    \section{Evolution of implementation}
        ...
        %     XFS?, BTRFS, fat32, gfs. Consider funneling the bits and pieces I
        %     mention throughout to here. Can have a short list of ALL FSs i
        %     mention throughout for reference
    ...
    \section{ext4}
        ...
        % pretty much that). THIS SUBCHAPTER NOT PROOFREAD!!!!
        ...
        \subsection{Data locality}
            % TODO: i have this label to reference the quote below. Maybe put it in HW considerations and quote here?
            % whatever you do, check all references to it as they might become wrong
            % maybe make a new section to introduce SSDs? sec_reliability has references that can be combined with this
            \label{sec_locality}
...
\chapter{Problem setting}
    ...
    % TODO: incorporate the reliability analysis of ZFS here
    % Does this go here? maybe background research
    \section{Scrubbing}
