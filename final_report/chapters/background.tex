\chapter*{Introduction}
    ...
    % check that i have all citations, i want to have ALL possible ones in here
...
\chapter{Background}
    ...
    \section{Evolution of implementation}
        ...
        \subsection{FFS}
            ...
            The result was that \cauthor{FFS} measured an increase in disk
        ...
        \subsection{LFS}
            ...
            However, \cauthor{IO_bottleneck} points out some issues with
            ...
            Further, \cauthor{IO_bottleneck} argues that such caching shifts
            ...
            \cauthor{LFS}, reiterates the necessity of asynchronous writes
    ...
    \section{Data integrity}
        ...
        \subsection{Drive reliability}
            ...
            per kilobyte of data read. As \cauthor{flash_reliability} and
            \cauthor{flash_large_scale} note, these failures are not uniform
...
\chapter{Problem setting}
    ...
    \section{The problem to address (conclusion)}
        ...
        % can say it's more likely to remain with nothing (said in intro)
