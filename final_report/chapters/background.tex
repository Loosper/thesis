...
\chapter{Lit review}
    \section{The UNIX filesystem}
        ...
        \cite{UFS}. All these features are still with us, largely unmodified,
    ...
    \section{Evolution of implementation}
        ...
        \subsection{LFS}
            ...
            used since \cite{Linux_VFS_cache}, \cite{IO_bottleneck}.
        ...
        \subsection{WAFL}
            ...
            to be atomic \cite{drive_atomicity} so updating the root an all or
            nothing operation, limiting the impact of a crash to only some data
            loss that hasn't had the time to be commited to disk.
