...
\chapter{Background}
    \section{The UNIX filesystem (UFS)}
        ...
        then rewritten with \syscall{write}). The operating system maintains the
        ...
        For the implementation to work, every file is assigned a number - its
        ...
        To implement this scheme was simple. It used a linear and fixed size
    ...
    \section{Evolution of UNIX based filesystem implementations}
        \subsection{The Fast Filesystem (FFS)}
            ...
            \cauthor{FFS} proposed many improvements to increase
        ...
        \subsection{The Log-structured Filesystem (LFS)}
            ...
            With advances in software and hardware, by \cyear{IO_bottleneck}
            ...
            However, \cauthor{IO_bottleneck} point out some issues with
            ...
            \cauthor{LFS}, reiterate the necessity of asynchronous writes
    ...
    \section{The B-tree}
        ...
        As explained by \cauthor{btree_ubiquitous}, B-trees are a
        ...
        Nodes can be efficiently searched when loaded in memory (with a binary
    ...
    \section{ext4}
        ...
        --numstat v5.16..v5.17 fs/ext4})}. It has existed since \cyear{ext4_origin}
        and it is about \numprint{60000} lines of code
        \footnote{\monospace{cloc fs/ext4}}, all of which makes it very mature. Importantly,
        ...
        \subsection{Metadata integrity}
            ...
            \cauthor{journaling_vs_soft_updates} presents a thorough
    ...
    \section{Data integrity}
        ...
        \subsection{Drive reliability}
            ...
            \cauthor{2D_RAID} puts it: "Flash is basically garbage. It
            ...
            \cauthor{flash_reliability} takes measurements over a vast
            ...
            between $10^{-8}$ and $10^{-5}$. \cauthor{bit_error_mlc} finds
            similar rates for MLC. On the other hand \cauthor{bit_error_qlc}
            finds that triple-level cell (TLC) and quad-level cell (QLC) flash
            suffer RBER rates of around $10^{-3}$ and $10^{-2}$ respectively.
            Although \cauthor{flash_reliability} also notes that RBER rates
            ...
            \cauthor{flash_error_manual} it is apparent that this is due to
        ...
        \subsection{At scale}
            ...
            Equally significant, every shard is checksummed to protect against data
...
\chapter{Problem setting}
    ...
    \section{The write hole}
        ...
        \autoref{sec:ZFS}), \nameref{sec:ext4} and \hyperref[sec:LFS]{LFS} and then
