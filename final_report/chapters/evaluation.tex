\chapter{Evaluation and results}
    ...
    \section{Benchmarking}
        ...
        raw throughput of data while \cauthor{LFS} recognise both small
        ...
        modification and \cauthor{ext4_space_maps} uses a small file
        ...
        % sequential performance - very important but mostly bragging rights - most accesses are smaller
        % random - realistic but over emphasised - say it's unlikely except in search
        ...
        % explain that NTFS is not a UNIX fs but may be good to see some results
    ...
    \section{Profiling analysis}
        ...
        % because their metadata is stored in files (\autoref{sec:files}). Since they
    ...
    %     As noted in the performance analysis \autoref{sec:perf}, this filesystem's
